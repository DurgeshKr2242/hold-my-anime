const Seeds = [
  {
    ...
    favChar: "Sotoru Gojo",
    note: "Jujutsu Kaisen is the latest shounen to gain a surge of popularity and get invited to join the mainstream table of the true anime titans, probably taking a seat right next to Demon Slayer. And I can say with certainty that this is primarily because of Studio Mappa's admirable dedication to making this show, particularly the fight scenes, look breathtakingly good. But here's the age old question: Does fantastic animation trump average writing. Yeah, no. Heh, sorry to be blunt. I guess I'm taking a lesson out of protagonist Itadoris book. But who's to say that Jujutsu doesn't have a bit of both? ",
    user: "Durgesh Kumar",
    rating: 4.5,
    likes: 33,
    comments: [],
